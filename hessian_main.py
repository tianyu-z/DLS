...
def main(args):
    ...
    trainloader, testloader, _, classes = load_dataset(
    ...
    if args.pretrain_type == 1:
        model.load_state_dict(
            torch.load(
                "logs_perf/CIFAR10/dict/Mar15_01:56:19_vipa-110_CIFAR10s56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-60-6000-6000-666-False.t7"
            )["state_dict"]
        )
    elif args.pretrain_type == 2:
        model.load_state_dict(
            torch.load(
                "logs_perf/CIFAR10/dict/Mar15_01:56:31_vipa-110_CIFAR10s56-512-ring-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-60-6000-6000-666-False.t7"
            )["state_dict"]
        )
    elif args.pretrain_type == 3:
        model.load_state_dict(
            torch.load(
                "logs_perf/CIFAR10/dict/Mar15_09:56:57_vipa-111_CIFAR10s56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-60-6000-6000-666-False.t7"
            )["state_dict"]
        )
    elif args.pretrain_type == 4:
        model.load_state_dict(
            torch.load(
                "logs_perf/CIFAR10/dict/Mar15_09:57:08_vipa-111_CIFAR10s56-64-ring-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-60-6000-6000-666-False.t7"
            )["state_dict"]
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode", default="power_iter", type=str, choices=["power_iter", "lanczos"]
    )
